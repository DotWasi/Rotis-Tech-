...
const TechItem = ({ name, description, icon }: { name: string, description: string, icon: React.ReactNode }) => (
    <div className="group relative bg-gray-800/40 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-gray-700/50 text-center transition-all duration-300 hover:-translate-y-1.5 h-full flex flex-col justify-center">
