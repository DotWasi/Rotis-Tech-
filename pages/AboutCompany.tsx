...
const AboutCompany = () => {
    return (
        <div className="animate-fade-in-up space-y-24">
            <section className="relative min-h-[50vh] flex items-center justify-center text-center rounded-xl overflow-hidden -mt-12">
            ...
            <section>
             ...
             <section className="bg-gray-800/50 p-8 rounded-lg shadow-xl border border-gray-700 flex flex-col md:flex-row items-center gap-8">
