...
const solutions = [
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1666875753105-c62a4da54895?q=80&w=1920&auto=format&fit=crop",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1586528116311-06924151da5a?q=80&w=1920&auto=format&fit=crop",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1547573854-74d2a71d0826?q=80&w=1920&auto=format&fit=crop",
        benefits: ["Instant Menu Updates", "A/B Test Menu Items", "Profitability Analysis per Item", "Scheduled Promotional Pricing"]
    },
    {
        title: "Contactless Guest Experience",
        description: "Meet modern expectations with a complete contactless solution. From QR code ordering at the table to seamless mobile payments, provide a safe, efficient, and convenient experience for every guest.",
        ...
        image: "https://images.unsplash.com/photo-1603204958890-a1a79919df4c?q=80&w=1920&auto=format&fit=crop",
        benefits: ["Increase Table Turnover", "Reduce Staff Workload", "Enhance Guest Safety", "Integrate with Loyalty Programs"]
    },
];
...
const pillarFeatures = [
    ...
    { title: "Customer Feedback Analysis (NLP)", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg> },
    { title: "AI-Powered Staff Scheduling", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg> },
        ...
        <div className="animate-fade-in-up">
            ...
            <div className="space-y-16">
                {solutions.map((solution, index) => (
                    <FeatureShowcase key={solution.title} feature={solution} isReversed={index % 2 !== 0} />
                ))}
            </div>
